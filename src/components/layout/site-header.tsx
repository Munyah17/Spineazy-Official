    ...
    <header className="sticky top-0 z-30 flex items-center gap-3 border-b border-border bg-background/95 px-3 py-3 backdrop-blur lg:px-6 lg:py-4">
      ...
      <div className="ml-auto flex items-center justify-end gap-2">
        ...
        {profile ? (
          <Link
            href="/wallet"
            className="flex items-center gap-1.5 rounded-lg bg-secondary px-2.5 py-1.5 text-sm font-semibold text-secondary-foreground transition-colors hover:bg-accent sm:gap-2 sm:px-3"
          >
